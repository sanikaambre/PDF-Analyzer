...
# Apply custom CSS for theme changes
st.markdown(
    """
    <style>
        /* Set the overall background color of the app */
        .stApp {
            background-color: #86DEDE;  /* Light Green Background */
        }

        /* Change primary button color to green */
        .stButton>button {
            background-color: #4CAF50 !important;  /* Green */
            color: white !important;
        }

        /* Change text color to black for the whole page */
        body, .stTextInput>label, .stMarkdown, .stText, .stRadio, .stSlider, .stSelectbox, .stCheckbox {
            color: #000000 !important;  /* Black text */
        }

        /* Styling for the Streamlit sidebar */
        .css-1d391kg {
            background-color: #86DEDE !important;  /* Sidebar Light Green */
        }
        ...
        /* Adjust the color of the Streamlit widgets */
        .stRadio>label, .stCheckbox>label, .stSelectbox>label, .stSlider>label {
            color: #000000 !important;
        }

        /* Make the top navigation bar green */
        header {
            background-color: #86DEDE !important;  /* Green Navbar */
        }

        /* Change the Deploy button color */
